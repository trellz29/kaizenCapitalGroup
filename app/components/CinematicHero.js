...
const ROLES = ["Allocation", "Growth", "Preservation", "Innovation", "Expansion"];
  ...
  return (
    <>
      ...
      <div className="hero-content-wrap" style={{
        ...
        padding: "clamp(80px,12vh,140px) clamp(1.5rem, 6vw, 80px) 5rem clamp(1.5rem, 6vw, 80px)",
        ...
        <p className="hero-desc" ref={subRef} style={{ opacity: 0 }}>
          Kaizen Capital Group operates multiple active funds across Gold, Forex, Crypto, and multi-asset strategies — built for serious investors seeking disciplined, institutional-grade execution.
        </p>
