...
export function VisHome() {
  ...
  return (
    <Scene glowLeft="62%">
      ...
      <Copy label="KCG Fund Dashboard" title="12 active funds. One disciplined platform." body="Every KCG fund is tracked, reported, and managed with institutional precision — visible at a glance." />
    </Scene>
  );
}
